...
XOC is the native token of the [Xone](https://xone.org/) blockchain, while WXOC (Wrapped XOC) is a mapped token used for interactions on the [Xone](https://xone.org/) Testnet. To use XOC on the [Xone](https://xone.org/) Mainnet, you need to exchange WXOC for XOC. According to the XOC token economy model, donated users receive WXOC tokens and acquire them linearly based on a planned ratio. This process is called "Release."
...
Visit the [Xone](https://xone.org/) XOC Release Page to start the process of releasing your XOC. <Link className='text-primaryHue' isExternal showAnchorIcon href="https://bvi.xone.org/en/dynamics/release?pageNum=1&pageSize=10&startTime=1747655084000&endTime=1748259884000&address=">Get started now</Link>

<ImageViewer src="/images/Release_main.png" alt="Release_main" />
...
<ImageViewer src="/images/Release_Connect_Wallet.png" alt="Release_Connect_Wallet" />
...
<ImageViewer src="/images/Release_Send_WXOC.png" alt="Release_Send_WXOC" />
...
After successfully sending WXOC to the [Xone](https://xone.org/) Testnet contract address, the Mainnet contract will begin verification. Once confirmed, your Mainnet wallet address will receive the corresponding amount of XOC tokens. Please switch to **[Xone](https://xone.org/) Mainnet** to check your balance.

</Steps>

## About the Release Mechanism

You may still be unsure about how the release mechanism works. Below, we provide an illustrated explanation of the [Xone](https://xone.org/) donation plan's token distribution and release mechanism.
...
sequenceDiagram
  participant Wallet
  participant [Xone](https://xone.org/) Testnet
  participant Web Server
  participant [Xone](https://xone.org/) Mainnet

  Wallet ->> [Xone](https://xone.org/) Testnet: Transfer WXOC

  activate [Xone](https://xone.org/) Testnet
  [Xone](https://xone.org/) Testnet -->> [Xone](https://xone.org/) Testnet: Burn WXOC
  [Xone](https://xone.org/) Testnet ->> Web Server: Notify Mint XOC
  deactivate [Xone](https://xone.org/) Testnet

  activate Web Server
  Web Server -->> Web Server: Verify info and Save
  Web Server ->> [Xone](https://xone.org/) Mainnet: Notify Execution
  deactivate Web Server

  activate [Xone](https://xone.org/) Mainnet
  [Xone](https://xone.org/) Mainnet ->> Web Server: Notify Finish Mint XOC
  deactivate [Xone](https://xone.org/) Mainnet
  ...
  activate [Xone](https://xone.org/) Mainnet
  [Xone](https://xone.org/) Mainnet ->> Wallet: Transfer Mainnet XOC
  deactivate [Xone](https://xone.org/) Mainnet
...
1. **Sending WXOC to the [Xone](https://xone.org/) Testnet Contract**  
  After the **[Xone](https://xone.org/) Mainnet launch**, you need to send the WXOC tokens you received from donations to the **[Xone](https://xone.org/) Testnet contract address**. Once the contract receives your tokens, it will **burn** them and record key information such as **amount, address, and timestamp** on the server.  

  🚨 *This step is crucial as it determines the amount of XOC you will receive on the [Xone](https://xone.org/) Mainnet.*  

2. **Data Verification & Locking**  
  The server **stores and verifies** the transaction data. After confirmation, it **notifies [Xone](https://xone.org/) Mainnet** to proceed with the XOC release. At this stage, the Testnet transaction details are officially recorded on the Mainnet, a process referred to as **locking** on the release page. Your XOC tokens will then be released **linearly** based on these records.  

3. **Gradual Release of XOC**  
  According to the rules, the contract on **[Xone](https://xone.org/) Mainnet** will **start releasing XOC** to the wallet address that interacted with the Testnet. The release follows a **linear schedule**, where tokens unlock **every Epoch after 50 Epochs**.  
...
At this point, we pass the donation plan rules; after the [Xone](https://xone.org/) Mainnet goes online, the number of tokens available for donors to release in the first Epoch is: 17,000,000.00 XOC.
...
In the above content, we assumed that you got 10,000.00 WXOC, then through calculation, you can immediately get 500.00 XOC released on [Xone](https://xone.org/) Mainnet.

<Callout type="warning" emoji="⚠️">
  **Release:** The amount of XOC you can get.\
  **LockWXOC:** The total amount you send to the [Xone](https://xone.org/) Testnet contract before the next release point. This value will be eliminated every time you successfully release.
</Callout>

...
Thank you for visiting <Link className='text-primaryHue' isExternal showAnchorIcon href="https://xone.org">xone.org</Link>. By browsing, accessing, or using <Link className='text-primaryHue' isExternal showAnchorIcon href="https://xone.org">xone.org</Link> and related applications and services (collectively, the "[Xone](https://xone.org/) Platform"), you ("User" or "You") agree to these Terms of Service (these "Terms"), so please read them carefully and keep a copy for reference. Please also note that certain terms or conditions may apply to you as a user in specific jurisdictions.

These Terms constitute the complete agreement and understanding between you and the [Xone](https://xone.org/) service provider ("we" or "us") regarding your use of any or all services and any method of accessing the services.
...
1.1 To the fullest extent permitted by applicable laws and regulations, we reserve the right to change or modify these Terms as well as any policies or guidelines on the [Xone](https://xone.org/) Platform at any time, at our sole discretion.

1.2 To the fullest extent permitted by applicable laws and regulations, you agree to waive any right to specific notification of such changes or modifications. Your continued use of the [Xone](https://xone.org/) services will constitute acceptance of such changes or modifications. If you disagree with the current Terms while accessing or using [Xone](https://xone.org/) services, you must cease using our services. We encourage you to regularly review the Terms to ensure you understand the terms and conditions that apply to your access to and use of the services. If you have any questions regarding your use of the [Xone](https://xone.org/) Platform, please contact us through the means provided in the <Link className='text-primaryHue' showAnchorIcon href="/study/service#24-contact-us">Contact Us</Link> section of this document.
...
<div className="overflow-x-auto">
  <Table removeWrapper aria-label="Example static collection table" className="mt-2">
    ...
    <TableBody>
      ...
      <TableRow key="4">
        <TableCell>**USDX**</TableCell>
        <TableCell>A stablecoin used within the [Xone](https://xone.org/) Chain ecosystem.</TableCell>
      </TableRow>
      <TableRow key="5">
        <TableCell>**XOC**</TableCell>
        <TableCell>The main chain token used within the [Xone](https://xone.org/) Chain ecosystem.</TableCell>
      </TableRow>
          <TableRow key="6">
        <TableCell>**Staking**</TableCell>
        <TableCell>	Locking up USDX to generate rewards based on contributions and duration.</TableCell>
      </TableRow>
    </TableBody>
  </Table>
</div>
...
5.1 The user acknowledges and agrees that, in the following situations, [Xone](https://xone.org/)’s operators reserve the right to suspend all or part of the Services or suspend user access to all or part of the Services at their discretion:

(a) The user may have violated these Terms; or

(b) The normal operation of the [Xone](https://xone.org/) Platform is at risk.

5.2 For the purposes of Clause 5.1(b), the normal operation of the [Xone](https://xone.org/) Platform is considered to be at risk in the following cases:

(a) Computer or telecommunications networks cease operations due to accidents; (b) Force majeure events affecting service provision; (c) Assets on [Xone](https://xone.org/) or user assets are subject to malicious attempts or actual attacks, posing theft or loss risks; (d) When any critical system relied upon by the [Xone](https://xone.org/) Platform (including the trading system or any other system necessary for providing the Services) faces operational challenges; (e) When [Xone](https://xone.org/) suspects unauthorized use of [Xone](https://xone.org/)’s Services, or violations of these Terms or applicable laws and regulations; (f) When [Xone](https://xone.org/) determines that suspension is necessary for investigation or to ensure the normal operation of [Xone](https://xone.org/) Chain; (g) When [Xone](https://xone.org/) decides to halt operations for underlying services upgrades or repairs; (h) When [Xone](https://xone.org/), due to legal or regulatory changes, social conditions, or factors beyond its control, deems it unable to continue providing Services; or (i) When [Xone](https://xone.org/) deems suspension necessary for other reasons.

### 6. Agreement to Terms

This End-User License Agreement and Terms of Service (“EULA” or “Terms”) is a binding contract between you (individual user or site visitor, whether in your personal capacity or on behalf of an entity, “User,” “You,” “Your”) and the [Xone](https://xone.org/) Foundation (“Foundation,” “We,” “Us”), governing your use of the Foundation’s services (the “Services”), including the website <Link className='text-primaryHue' isExternal showAnchorIcon href="https://xone.org">xone.org</Link> and any related, linked, or connected media form, media channel, or mobile website (collectively, the “Site”).

Currently, [Xone](https://xone.org/) Foundation maintains and operates <Link className='text-primaryHue' isExternal showAnchorIcon href="https://xone.org">xone.org</Link> and all Services related to [Xone](https://xone.org/) Chain as a **portal for news, information, and updates concerning the [Xone](https://xone.org/) Protocol or Blockchain (“[Xone](https://xone.org/) Network”) and the [Xone](https://xone.org/) ecosystem. To avoid doubt, the Foundation does not control the [Xone](https://xone.org/) Network, nor the activities or data on the network, application development and usage by individuals on the network, transaction validation on the [Xone](https://xone.org/) Network, or network usage.** The [Xone](https://xone.org/) Network is maintained and processed by the global Huione network validators as an open-source protocol.

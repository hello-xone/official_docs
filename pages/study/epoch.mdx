...
Through the Xone block browser, enter the block height to query the number of remaining blocks and the estimated end time of the current Epoch. <Link className='text-primaryHue' isDisabled showAnchorIcon href="https://xonescan.com/contract-verification">you can also access it directly here</Link>.

...
Amid the wave of Web3, [Xone](https://xone.org/) Chain firmly believes that developers are the true driving force of the ecosystem. To unlock the innovative potential of global developers, foster ecosystem prosperity, boost TVL, and create user value, [Xone](https://xone.org/) has launched the official **[Xone](https://xone.org/) Grant Program**. Through multi-dimensional incentives — including financial support, technical assistance, market resources, and governance participation — the program empowers developers to build high-quality on-chain applications and infrastructure within the [Xone](https://xone.org/) ecosystem.
...
[Xone](https://xone.org/) Grant focuses on six core areas, while also encouraging any creative projects that advance the progress of the [Xone](https://xone.org/) ecosystem.
...
To ensure project quality and efficient use of funds, the [Xone](https://xone.org/) Grant sets the following basic application requirements:
  ...
  <Table removeWrapper aria-label="Xone Grant Application Requirements" className="mt-2">
    ...
    <TableBody>
      ...
      <TableRow key="5">
        ...
        <TableCell>Explain why [Xone](https://xone.org/) was chosen and how its on-chain features will be leveraged (e.g., low gas fees, BVI mining, genealogy system).</TableCell>
      </TableRow>
      <TableRow key="6">
        <TableCell>✅ Community Participation</TableCell>
        <TableCell>Commitment to engage with the [Xone](https://xone.org/) community, such as contributing documentation, organizing events, co-marketing, or governance voting.</TableCell>
      </TableRow>
    </TableBody>
  </Table>
</div>
...
The [Xone](https://xone.org/) Grant adopts a “Milestone + Verification” model, balancing quick project launches with on-chain performance, while avoiding resource waste.
...
<div class="mt-2 md:mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
  ...
  <Card className="flex-shrink-0 max-w-full flex-col">
    ...
    <CardBody className="px-3 pt-0 pb-3 text-small">
      <p>For projects with strategic impact on [Xone](https://xone.org/), such as core infrastructure, DeFi protocols, or flagship GameFi projects.  
...
<div className="overflow-x-auto">
  <Table removeWrapper aria-label="Xone Grant Launch Incentive" className="mt-2">
    ...
    <TableBody>
      <TableRow key="1">
        <TableCell>Project deployed on [Xone](https://xone.org/) Mainnet (Official PPT + Smart Contract Deployment + DApp Page Online)</TableCell>
      ...
      <TableRow key="4">
        <TableCell>Official [Xone](https://xone.org/) media exposure (AMA, Tweet, Space)</TableCell>
        <TableCell>+10,000 XOC</TableCell>
        <TableCell>
          1. At least 1 AMA<br />
  ...
  <Table removeWrapper aria-label="Xone Grant Evaluation Criteria" className="mt-2">
    ...
    <TableBody>
      ...
      <TableRow key="3">
        ...
        <TableCell>20%</TableCell>
        <TableCell>Leverages [Xone](https://xone.org/) features (Genealogy System, BVI, XOC/USDX)</TableCell>
      </TableRow>
      <TableRow key="4">
...
sequenceDiagram
  ...
  participant XoneLabs as [Xone](https://xone.org/) Labs
...
- ✅ [Xone](https://xone.org/) Labs incubator integration service
...
<Callout>
At [Xone](https://xone.org/), we provide not only funding but also the fertile ground for growth.\

...
1. Create a new <Link className='text-primaryHue' isExternal showAnchorIcon href="https://github.com/hello-xone/official_docs/issues/new/choose">pull request on GitHub</Link>.  

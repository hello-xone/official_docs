...
This guide provides step-by-step instructions to deploy an ERC-721 (NFT) token on the **[Xone](https://xone.org/) Chain** for creating a unique **Fruit NFT Collection**. Each NFT represents a unique fruit, making it ideal for collectibles, games, or creative projects.
...
1. <Link className='text-primaryHue' isExternal showAnchorIcon href="https://metamask.io/">MetaMask Wallet</Link> configured for the [Xone](https://xone.org/) Chain network.
2. Open <Link className='text-primaryHue' isExternal showAnchorIcon href="https://remix.ethereum.org">Remix IDE</Link>.
3. Test XOC ([Xone](https://xone.org/) Chain test tokens) for Gas fees. Use the <Link className='text-primaryHue' isExternal showAnchorIcon href="https://faucet.xone.org/">Xone Faucet</Link> to get free tokens.
...
```
<ImageViewer src="/images/Create ERC-721.png" alt="Create ERC-721" />
...
<ImageViewer src="/images/Create ERC-721_1.png" alt="Create ERC-721_1" />
...
<ImageViewer src="/images/Create ERC-721_2.png" alt="Create ERC-721_2" />
...
<ImageViewer src="/images/Create ERC-721_3.png" alt="Create ERC-721_3" />
...
<ImageViewer src="/images/Create ERC-721_4.png" alt="Create ERC-721_4" />
...
<ImageViewer src="/images/Create ERC-721_5.png" alt="Create ERC-721_5" />
...
<ImageViewer src="/images/Create ERC-721_6.png" alt="Create ERC-721_6" />

4. View <Link className='text-primaryHue' isExternal showAnchorIcon href="https://testnet.xonescan.com/token/0x2BEe15B258964564efF99b22C98AD9cd8c30B842/instance/0">FruitNFT #0</Link> on the [Xone](https://xone.org/) explorer.

<ImageViewer src="/images/Create ERC-721_7.png" alt="Create ERC-721_7" />
...
<ImageViewer src="/images/Create ERC-721_9.png" alt="Create ERC-721_9" />
...
<ImageViewer src="/images/Create ERC-721_8.png" alt="Create ERC-721_8" />

...
2. Install the <Link className='text-primaryHue' isExternal showAnchorIcon href="https://metamask.io/">MetaMask</Link> extension and configure it to connect to the [Xone](https://xone.org/) testnet.
...
3. Check smart contract address (e.g.: <Link className='text-primaryHue' isExternal showAnchorIcon href="https://testnet.xonescan.com/token/0xb1a04485443d937e8eEbd260AE954BC3C006422F">0xb1a04485443d937e8eEbd260AE954BC3C006422F</Link>).

...
When users open <Link className='text-primaryHue' isExternal showAnchorIcon href="https://metamask.io/">MetaMask</Link>, they initially see a selection of major tokens. To display additional custom <DynamicLangLink className='text-primaryHue' showAnchorIcon basePath='/developers/standard' subPath='/erc20'>ERC-20 tokens</DynamicLangLink>, users must either enable token autodetection or add the tokens manually. Similarly, <DynamicLangLink className='text-primaryHue' showAnchorIcon basePath='/developers/standard' subPath='/erc721'>for NFTs</DynamicLangLink>, users need to enable NFT autodetection or manually add them.

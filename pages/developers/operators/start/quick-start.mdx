...
To ensure a quick and accurate synchronization to the latest node state, you must restore from a snapshot. For detailed instructions, please refer to [Using Snapshots](/developers/operators/start/using-snapshots).

---
description: "A Linux server (Ubuntu\_24.04+ recommended)"
...
Download the Latest Binary From Github: https://github.com/hello-xone/xone_chain/releases
```bash showLineNumbers copy
# Change to a temporary directory
cd /tmp

# Download the official configuration template
wget https://xone-mainnet.s3.ap-southeast-1.amazonaws.com/config.zip
```

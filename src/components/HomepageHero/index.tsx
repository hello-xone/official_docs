import { XoneLogo } from '@/components/XoneLogo'
import classes from './animatedStars.module.css'
import { Video } from './Video'

export default function Hero() {
  return (
    <div className="bg-transparent relative flex items-center justify-center min-h-screen">
      {' '}
      {/* 使用min-h-screen确保容器高度至少为屏幕高度 */}
      ...
      <div className="relative isolate px-6 pt-16 pb-20 lg:px-8 flex flex-col items-center justify-center max-w-screen-lg mx-auto">
        {' '}
        {/* 添加max-w-screen-lg和mx-auto确保内容在大屏设备上不会过宽 */}
        <div
          aria-hidden="true"
        ...
        <div className="text-center">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm dark:text-white leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              {' '}
              <a href="/docs/bvi/readme" className="font-semibold text-primaryHue">
          ...
          <div className="flex justify-center my-5">
            <div
              style={{
                ...
                width: '100%',
                maxWidth: '90vw',
                aspectRatio: '16/9', // 使用aspectRatio代替paddingBottom以确保视频比例正确
                height: 'auto',
              }}
            >
